...
"pho-muenchen": {
  "title": "Pho",
  "highlighted": true,
  "address": "Nymphenburger Straße 70, 80335 München",
  "openingHours": "täglich 11:30 - 15:30 und 17:30 - 22:00",
  "distance": "150 m",
  "time": "2 min",
  "meals": [
    {
      name: "01 Sommerrollen frisch mit Garnelen",
      description: "GÔI CUÕN TÔM",
      price: 3.9
    },
    {
      name: "02 Sommerrollen frisch mit Tofu",
      description: "GÔI CUÕN CHAY",
      price: 3.9
    },
    {
      name: "03 Sommerrollen frittiert mit Meeresfrüchten",
      description: "NEM HĂI SĂN",
      price: 3.9
    },
    {
      name: "04 Sommerrollen frittiert mit Gemüse",
      description: "NEM CHAY",
      price: 3.9
    },
    {
      name: "05 Vorsuppe mit Nudeln & Rind",
      description: "CANH PHÔ BƠ",
      price: 3.9
    },
    {
      name: "06 Vorsuppe mit Nudeln & Huhn",
      description: "CANH PHÔ GÂ",
      price: 3.9
    },
    {
      name: "07 Vorsuppe mit Gemüse",
      description: "CANH RAU",
      price: 3.9
    },
    {
      name: "08 Tom Yum Suppe",
      description: "CANH CHUA THAI",
      price: 3.9
    },
    {
      name: "09 Mango Salat",
      description: "GÔI XOÂI",
      price: 3.9
    },
    {
      name: "09 Salat mit Garnelen",
      description: "GÔI TÔM",
      price: 3.9
    },
    {
      name: "09 Salat mit Hähnchenstreifen",
      description: "GÂ XÊ PHAY",
      price: 3.9
    },
    {
      name: "10 Gebratene Nudeln mit Rind (medium)",
      description: "PHÔ XÂO BƠ",
      price: 6.9
    },
    {
      name: "10 Gebratene Nudeln mit Rind (large)",
      description: "PHÔ XÂO BƠ",
      price: 8.9
    },
    {
      name: "11 Gebratene Nudeln mit Huhn (medium)",
      description: "PHÔ XÂO GÂ",
      price: 6.9
    },
    {
      name: "11 Gebratene Nudeln mit Huhn (large)",
      description: "PHÔ XÂO GÂ",
      price: 8.9
    },
    {
      name: "11 Gebratene Nudeln mit Gemüse (medium)",
      description: "PHÔ XÂO CHAY",
      price: 6.9
    },
    {
      name: "11 Gebratene Nudeln mit Gemüse (large)",
      description: "PHÔ XÂO CHAY",
      price: 8.9
    },
    {
      name: "11 Gebratene Nudeln mit Garnelen (medium)",
      description: "PHÔ XÂO TÔM",
      price: 6.9
    },
    {
      name: "11 Gebratene Nudeln mit Garnelen (large)",
      description: "PHÔ XÂO TÔM",
      price: 8.9
    }
  ],
...
"gasthaus-kueblboeck": {
  "title": "Gasthaus Küblböck",
  "address": "Ansprengerstraße 16, 80803 München",
  "openingHours": "nur auf Anfrage geöffnet",
  "distance": "150 m",
  "time": "2 min",
  "meals": [
    {
      name: "Pulled Pork",
      description: "American Style mit Kartoffelsalat",
      price: 12.5
    }
  ],
  "beverages": [
    {
      name: "The Duke",
      description: "Munich Dry Gin",
      price: 7
    },
    {
      name: "Granit",
      description: "Bavarian Gin",
      price: 7
    },
    {
      name: "Feel",
    ...
    {
      name: "Monkey 47",
      description: "Schwarzwald Dry Gin",
      price: 7
    },
    {
      name: "fritz-kola",
      description: "vielviel Koffein",
      price: 2
    },
    {
  ...
  "name": "gasthaus-kueblboeck"
},
"franz-josef": {
  "title": "Franz Josef",
  "address": "Nymphenburger Straße 64, 80335 München",
  "distance": "150 m",
  "time": "2 min",
  "meals": [
    "Feuriges Chili con Carne mit ofenfrischem Baguette",
    "Gebratene Fasanenbrust auf Weinkraut mit glasierten Trauben und Kartoffelplätzchen",
    "Original Münchner Schweinsbraten mit rescher Kruste und Dunkelbiersoße, dazu gibt es hand geriebene Kartoffelknödel und Krautsalat",
    "Zarter Rindertafelspitz mit Steirischem Meerrettich, Wurzelgemüse und Röstkartoffeln"
  ],
  "beverages": [
    "Wasser",
    "Spezi",
...
"spring-fromage-fort": {
  "title": "Fromage Fort",
  "address": "When I’ve got too many cheese bits on hand, it's now fromage fort to the rescue",
  "distance": "150 m",
  "time": "2 min",
  "meals": [
...
"spring-ragu-bolognese": {
  ...
  "address": "A certain magic happens as the beef and aromatic vegetables slowly cook down with wine, tomato paste, and broth",
  "distance": "100 m",
  "time": "1 min",
  "meals": [
...
"spring-animal-cracker-cookies": {
  ...
  "address": "Create and decorate magical cookies that are as much fun as a day at the circus!",
  "distance": "1 km",
  "time": "10 min",
  "meals": [
...
"spring-chicken-in-mole": {
  ...
  "address": "If there is one dish that could be considered Mexican haute cuisine, then Mole Poblano is surely it",
  "distance": "2 km",
  "meals": [
...
"spring-spanish-asparagus-revuelto": {
  ...
  "address": "In Spain, wild asparagus is very popular, and it’s a sure sign of spring",
  "distance": "300 m",
  "meals": [
    "Olive oil",
...
"spring-meatloaf": {
  ...
  "highlighted": true,
  "address": "It is a thing of beauty, shaped into a large oval loaf and glazed with tangy cocktail sauce",
...
"spring-easiest-spaghetti-and-meatballs": {
  ...
  "address": "No pasta's more iconic than spaghetti and meatballs",
  "distance": "30 min",
  "meals": [
...
"summer-shaking-beef": {
  ...
  "address": "Cubes of tender filet mignon are sautéed with red onions and a vinaigrette",
  "distance": "25 min",
  "meals": [
...
"summer-apricots-honey-panna-cotta": {
  ...
  "highlighted": true,
  "address": "Juicy, fragrant, perfectly textured for a little fire action",
  "source": {
    "name": "Tartelette",
...
"summer-elderberry-syrup": {
  ...
  "address": "The gorgeous syrup is great in a glass of sparkling water over ice, dripped some over plain yogurt",
  "source": {
    "name": "David Lebovitz",
...
"summer-spaghetti-lemon-olive": {
  ...
  "address": "This is one of those recipes that are almost better off without one",
  "source": {
...
"summer-hamburger": {
  ...
  "address": "This is the traditional, griddled hamburger of diners and takeaway spots, smashed thin and cooked crisp on its edges",
  "source": {
    "name": "NY Times",
...
"fall-roasted-butternut-squash-lasagna": {
  ...
  "highlighted": true,
  "address": "Making homemade pasta may seem arduous, but this dish is worth the extra work",
  "source": {
    "name": "Martha Stewart",
...
"summer-grits-icecream": {
  ...
  "address": "\"Decadent\" isn’t a word we throw around lightly",
  "source": {
    "name": "Anson Mills",
    "url": "http://www.ansonmills.com/recipes/480?recipes_by=grain"
  },
  "distance": "2 hr 20 min",
  "meals": [
...
"fall-peanut-butter-cookie": {
  ...
  "address": "This recipe takes Peanut Butter Cookies to the next level",
  "source": {
    "name": "David Lebovitz",
...
"fall-amatriciana": {
  ...
  "address": "This dish is named for the town of Amatrice...considered by many Italians to be birthplace of the best cooks on the peninsula",
  "source": {
    "name": "Mario Batali",
...
"fall-orecchiette-sausage-ragu": {
  ...
  "address": "Chef di Cucina Matt Abdoo expounded on the virtues of the fundamental building block of Italian cooking: fresh pasta",
  "source": {
    "name": "Mario Batali",
...
"winter-braised-duck": {
  ...
  "highlighted": true,
  "address": "A good braise always trumps a steak or a roast, both in terms of complex flavors and satisfaction",
  "source": {
    "name": "NY Times",
...
"fall-chocolate-chai-cupcake": {
  ...
  "address": "The moist chocolatey goodness of the cake can live on its own",
  "source": {
...
"fall-whole-wheat-goldfish-crackers": {
  ...
  "beverages": [
    "Preheat oven to 350°F. Combine all meals in a food processor, running the machine until the dough forms a ball, about two minutes.",
...
"winter-world-peace-cookie": {
  ...
  "address": "Shortbread cookie meets salted chocolate chip, and world peace feels within reach",
  "source": {
    "name": "Food52",
...
"winter-chocolate-tart": {
  ...
  "highlighted": true,
  "address": "A good chocolate tart doesn’t need to be fancy, but it needs to be deep, dark, and yes, somewhat decadent.",
  "source": {
    "name": "David Lebovitz",
...
"winter-cashew-gateau": {
  ...
  "address": "The inspiration for the caramel stained \"glass\" panel comes from my grandmother",
  "source": {
    "name": "Tartelette",
